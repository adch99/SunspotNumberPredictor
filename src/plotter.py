...
def plot_predictions(net, x_train, y_train, idx_train, x_val, y_val, idx_val):
    ...
    ax1.plot(idx_val, y_val, label="Actual Data", marker="+", linestyle="none")
    ax1.plot(idx_val, pred1, label="Prediction", marker="o", linestyle="none")
    ...
    ax2.plot(idx_train, y_train, label="Actual Data", marker="+", linestyle="none")
    ax2.plot(idx_train, pred2, label="Prediction", marker="o", linestyle="none")
