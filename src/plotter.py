...
def plot_predictions(net, x_train, y_train, x_val, y_val):
    ...
    ax1.plot(y_val, label="Actual Data", marker="+", linestyle="none")
    ax1.plot(pred1, label="Prediction", marker="o", linestyle="none")
    ...
    ax2.plot(y_train, label="Actual Data", marker="+", linestyle="none")
    ax2.plot(pred2, label="Prediction", marker="o", linestyle="none")
